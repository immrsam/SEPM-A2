...
public class MainMenu {
	...
	public static void staffMainMenuOptions(Scanner input, int userID) {
		int choice = 0;
        do {
            ...
            switch (choice) {
	            case 1:
	                ...
	                continue;
	            case 2:
	            	printViewTicketHeader(); // view ticket header
	...
	public static void techMainMenuOptions(Scanner input, int userID) {
		int choice = 0;
		do {
            ...
            switch (choice) {
	            case 1:
	            	printOpenTicketHeader(); // view open ticket header
	            	openTicketProcessor(userID); // open ticket processes
	                continue;
	            case 2:
	            	printClosedTicketHeader(); // view closed ticket header
	            	closedTicketProcessor(userID); // view existing ticket processes
	                continue;
	            case 3:
	            	break;
	            default:
